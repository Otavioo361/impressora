...
import br.edu.lps.misael_otavio.sistema_gerenciamento_aluguel_impressoras.model.entities.compositeIds.ImpressoraGrupoImpressoraId;
...
public class ImpressoraGrupoImpressora {
    @EmbeddedId
    private ImpressoraGrupoImpressoraId id;

    @MapsId("idGrupoImpressora")
