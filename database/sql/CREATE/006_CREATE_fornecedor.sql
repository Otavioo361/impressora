...
BEGIN
  CREATE TABLE alugel_impressora.dbo.impressora (
    ...
    id_fornecedor_impressora INT NOT NULL,
    ...
    CONSTRAINT FK02_impressora_X_fornecedor FOREIGN KEY (id_fornecedor_impressora) REFERENCES alugel_impressora.dbo.tipo_impressora(id_fornecedor)
  );
END;