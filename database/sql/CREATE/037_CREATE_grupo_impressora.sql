...
BEGIN
  CREATE TABLE aluguel_impressora.dbo.grupo_impressora (
    ...
    CONSTRAINT FK01_grupo_impressora_X_contrato FOREIGN KEY (id_contrato) REFERENCES aluguel_impressora.dbo.contrato(id_contrato),
