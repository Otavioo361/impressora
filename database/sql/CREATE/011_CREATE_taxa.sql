...
BEGIN
  CREATE TABLE aluguel_impressora.dbo.taxa (
    ...
    CONSTRAINT FK01_taxa_X_tipo_recorrencia FOREIGN KEY (id_tipo_recorrencia) REFERENCES aluguel_impressora.dbo.tipo_recorrencia(id_tipo_recorrencia)
  );
END;